...
/**
 * The persistent class for the WORK_COMMAND_BAK database table.
 * 
 */
@Entity
@Table(name="WORK_COMMAND_BAK")
@NamedQuery(name="WorkCommandBak.findAll", query="SELECT w FROM WorkCommandBak w")
public class WorkCommandBak implements Serializable {
