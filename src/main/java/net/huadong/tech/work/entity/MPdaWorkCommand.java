 ...
 */
@Entity
@Table(name="M_PDA_WORK_COMMAND")
@NamedQuery(name="MPdaWorkCommand.findAll", query="SELECT w FROM MPdaWorkCommand w")
public class MPdaWorkCommand implements Serializable {
	...
	@Column(name="CY_ROW_NO1")
	private String cyRowNo1;
	
	@Column(name="CY_BAY_NO1")
	private String cyBayNo1;
	...
	public String getCyRowNo1() {
		return cyRowNo1;
	}

	public void setCyRowNo1(String cyRowNo1) {
		this.cyRowNo1 = cyRowNo1;
	}

	public String getCyBayNo1() {
		return cyBayNo1;
	}

	public void setCyBayNo1(String cyBayNo1) {
		this.cyBayNo1 = cyBayNo1;
	}
