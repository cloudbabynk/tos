 ...
 */
@Entity
@Table(name="CONSTRUCTION_PLAN_BAK")
@NamedQuery(name="ConstructionPlanBak.findAll", query="SELECT c FROM ConstructionPlanBak c")
public class ConstructionPlanBak extends AuditEntityBean implements Serializable {
