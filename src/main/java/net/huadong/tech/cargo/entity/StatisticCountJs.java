 ...
 */
@Entity
@Table(name="STATISTIC_COUNT_JS")
@NamedQuery(name="StatisticCountJs.findAll", query="SELECT s FROM StatisticCountJs s")
public class StatisticCountJs implements Serializable {
