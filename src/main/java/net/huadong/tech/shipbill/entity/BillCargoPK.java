...
/**
 * The primary key class for the BILL_CARGO database table.
 * 
 */
@Embeddable
public class BillCargoPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof BillCargoPK)) {
			return false;
		}
		BillCargoPK castOther = (BillCargoPK)other;
		return 
