 ...
 */
@Entity
@Table(name = "SHIP_BILL_RECORD")
@NamedQuery(name = "ShipBillRecord.findAll", query = "SELECT s FROM ShipBillRecord s")
public class ShipBillRecord extends AuditEntityBean implements Serializable {
