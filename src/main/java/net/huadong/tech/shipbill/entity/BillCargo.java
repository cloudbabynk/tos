...
/**
 * The persistent class for the BILL_CARGO database table.
 * 
 */
@Entity
@Table(name="BILL_CARGO")
@NamedQuery(name="BillCargo.findAll", query="SELECT b FROM BillCargo b")
public class BillCargo implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private BillCargoPK id;
	...
	public BillCargoPK getId() {
		return this.id;
	}

	public void setId(BillCargoPK id) {
		this.id = id;
	}
