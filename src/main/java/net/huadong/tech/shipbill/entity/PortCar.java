...
@Entity
@Table(name="PORT_CAR")
@NamedQuery(name="PortCar.findAll", query="SELECT p FROM PortCar p")
public class PortCar extends AuditEntityBean implements Serializable {
	...
	@Transient
	private String sffx;//是否放行，海关放行信息
