 ...
 */
@Entity
public class ContractIeDocQuery extends AuditEntityBean implements Serializable {
	...
	@Column(name="WORK_WAY_NAM")
	private String workWayNam;
	...
	public String getWorkWayNam() {
		return workWayNam;
	}
	public void setWorkWayNam(String workWayNam) {
		this.workWayNam = workWayNam;
	}
