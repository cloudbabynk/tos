 ...
 */
@Entity
@Table(name="C_SHIP_DATA")
@NamedQuery(name="CShipData.findAll", query="SELECT c FROM CShipData c")
public class CShipData extends AuditEntityBean  implements Serializable {
