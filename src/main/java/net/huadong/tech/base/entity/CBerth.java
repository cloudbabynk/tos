...
public class CBerth implements Serializable {
	...
	@Column(name="GROUP_BERTH_COD")
	private String groupBerthCod;
...
//	private List<CCable> CCables;
	...
	public String getGroupBerthCod() {
		return groupBerthCod;
	}

	public void setGroupBerthCod(String groupBerthCod) {
		this.groupBerthCod = groupBerthCod;
	}
