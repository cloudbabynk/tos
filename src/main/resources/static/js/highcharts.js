...
function(C) {
    ...
    function L(a, b, c) {
        ...
        else if (q(b) && Z(b)) for (d in b) a.setAttribute(d, b[d]);
        return e
    }
    function ta(a) {
        return Ja(a) ? a: [a]
    ...
    function La(a, b) {
        ...
        e, f, g, h, i, k = []; (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                h = O.lang,
                i = void 0,
                /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = u.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep: ""))) : e = Ra(f, e)
            }
            k.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}": "{"
    ...
    qb.prototype = {
        ...
        run: function(a, b, c) {
            ...
            this.pos = 0;
            e.elem = this.elem;
            if (e() && Fa.push(e) === 1) e.timerId = setInterval(function() {
    ...
    H = function(a, b, c, d) {
        ...
        e = a.hcEvents;
        var f, g, h, i, c = c || {};
        if (z.createEvent && (a.dispatchEvent || a.fireEvent)) e = z.createEvent("Events"),
        e.initEvent(b, !0, !0),
        e.target = a,
        v(e, c),
    ...
    Xa = function(a, b, c) {
        ...
        f = null,
        h === "d" ? (g.paths = g.initPath(a, a.d, b.d), g.toD = b.d, d = 0, f = 1) : a.attr ? d = a.attr(h) : (d = parseFloat(Ga(a, h)) || 0, h !== "opacity" && (e = "px")),
        f || (f = b[h]),
    ...
    Array.prototype.filter || (Oa = function(a, b) {
    ...
    u.stop = Pa;
    O = {
        colors: "#FC8A04,#4B9C09,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#2b908f,#f45b5b,#91e8e1".split(","),
...
//            text: "Highcharts.com",
    ...
    ia.prototype = {
        ...
        init: function(a) {
            var b, c, d, e;
            if ((this.input = a) && a.stops) this.stops = Ha(a.stops,
            function(a) {
                return new ia(a[1])
            });
        ...
        brighten: function(a) {
            ...
            else if (ka(a) && a !== 0) for (b = 0; b < 3; b++) c[b] += F(a * 255),
            c[b] < 0 && (c[b] = 0),
            c[b] > 255 && (c[b] = 255);
            return this
        },
    ...
    Q.prototype = {
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                r = r.join(",");
                i[r] ? n = i[r].attr("id") : (g.id = n = "highcharts-" + Ab++, i[r] = k = d.createElement(f).attr(g).add(d.defs), k.radAttr = h, k.stops = [], o(j,
                function(a) {
        ...
        updateShadows: function(a, b) {
            ...
            d = c.length; d--;) c[d].setAttribute(a, a === "height" ? Math.max(b - (c[d].cutHeight || 0), 0) : a === "d" ? this.d: b)
        },
        addClass: function(a) {
            var b = this.element,
            c = L(b, "class") || "";
        ...
        on: function(a, b) {
            ...
            d.onclick = function(a) { (Aa.indexOf("Android") === -1 || oa.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a)
            }) : d["on" + a] = b;
            return this
        },
        ...
        align: function(a, b, c) {
            ...
            f = e.alignedObjects;
            if (a) {
                if (this.alignOptions = a, this.alignByTranslate = b, !c || ya(c)) this.alignTo = d = c || "renderer",
                ma(f, this),
                f.push(this),
                c = null
            ...
            if (!c) {
                if (h.namespaceURI === Ea || d.forExport) {
                    try {
                        ...
                        Na && j.textShadow ? (k = j.textShadow, j.textShadow = "") : m && m("none"),
                        c = h.getBBox ? v({},
                        h.getBBox()) : {
                            width: h.offsetWidth,
                ...
                if (d.isSVG) {
                    ...
                    if (f) c.width = P(e * aa(g)) + P(d * T(g)),
                    c.height = P(e * T(g)) + P(d * aa(g))
                }
                if (t) {
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c) L(f, "height", s(L(f, "height") - h, 0)),
                    f.cutHeight = h;
        ...
        zIndexSetter: function(a, b) {
            ...
            if (e) {
                ...
                d = c.childNodes;
                for (i = 0; i < d.length && !h; i++) if (e = d[i], f = L(e, "zIndex"), e !== g && (F(f) > a || !q(a) && q(f))) c.insertBefore(g, e),
                h = !0;
                h || c.appendChild(g)
            }
            return h
    ...
    Ba.prototype = {
        ...
        init: function(a, b, c, d, e, f) {
            ...
            this.boxWrapper = d;
            this.alignedObjects = [];
            this.url = (Na || nb) && z.getElementsByTagName("base").length ? C.location.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
        ...
        buildText: function(a) {
            ...
            c = this,
            d = c.forExport,
            e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, k = L(b, "x"), j = a.styles, m = a.textWidth, l = j && j.lineHeight, n = j && j.textShadow, t = j && j.textOverflow === "ellipsis", r = g.length, X = m && !a.added && this.box, y = function(a) {
                return l ? F(l) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize: j && j.fontSize || c.style.fontSize || 12, a).h
            },
            x = function(a) {
                return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
            }; r--;) b.removeChild(g[r]); ! f && !n && !t && e.indexOf(" ") === -1 ? b.appendChild(z.createTextNode(x(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, X && X.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), o(e,
            function(e, f) {
                var g, l = 0,
                ...
                function(e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            L(r, n);
                            b.appendChild(r); ! l && f && (!da && d && M(r, {
                                display: "block"
                            }), L(r, "dy", y(r)));
                            if (m) {
                                for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), X = g.length > 1 || f || n.length > 1 && j.whiteSpace !== "nowrap", o, w, q, s = [], v = y(r), B = 1, A = a.rotation, u = e, D = u.length; (X || t) && (n.length || s.length);) a.rotation = 0,
                                o = a.getBBox(!0),
                                q = o.width,
                                !da && c.forExport && (q = c.measureSpanWidth(r.firstChild.data, a.styles)),
                                o = q > m,
                                w === void 0 && (w = o),
                                t && w ? (D /= 2, u === "" || !o && D < 0.5 ? n = [] : (o && (w = !0), u = e.substring(0, u.length + (o ? -1 : 1) * ua(D)), n = [u + (m > 3 ? "\u2026": "")], r.removeChild(r.firstChild))) : !o || n.length === 1 ? (n = s, s = [], n.length && (B++, r = z.createElementNS(Ea, "tspan"), L(r, {
                                    dy: v,
                                    x: k
                                }), p && L(r, "style", p), b.appendChild(r)), q > m && (m = q)) : (r.removeChild(r.firstChild), s.unshift(n.pop())),
                                n.length && r.appendChild(z.createTextNode(n.join(" ").replace(/- /g, "-")));
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            ...
            p = h.style;
            delete h.style;
            N(k.element, za ? "mouseover": "mouseenter",
            function() {
                j !== 3 && k.attr(f).css(t)
            });
            N(k.element, za ? "mouseout": "mouseleave",
            function() {
                j !== 3 && (m = [e, f, g][j], l = [n, t, r][j], k.attr(m).css(l))
            });
            k.setState = function(a) { (k.state = j = a) ? a === 2 ? k.attr(g).css(r) : a === 3 && k.attr(h).css(p) : k.attr(e).css(n)
            };
            return k.on("click",
            function(a) {
                j !== 3 && d.call(k, a)
        ...
        symbol: function(a, b, c, d, e, f) {
            ...
            k = a.match(i)[1],
            a = Nb[k] || f && f.width && f.height && [f.width, f.height],
            g = this.image(k).attr({
                x: b,
                y: c
            }),
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            ...
            J = function() {
                ...
                if (z) {
                    if (!l) a = ca,
                    b = (h ? -u: 0) + ca,
                    j.box = l = d ? k.symbol(d, a, b, j.width, j.height, gb) : k.rect(a, b, j.width, j.height, 0, gb["stroke-width"]),
        ...
        var Cb = {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    w, q = [],
                    ca = function() {
                        h = ['<fill colors="' + q.join(",") + '" opacity="', r, '" o:opacity2="', t, '" type="', i, '" ', x, 'focus="100%" method="any" />'];
                    ...
                    if (c === "fill") if (i === "gradient") c = l.x1 || l[0] || 0,
                    a = l.y1 || l[1] || 0,
                    n = l.x2 || l[2] || 0,
                    l = l.y2 || l[3] || 0,
                    x = 'angle="' + (90 - V.atan((l - a) / (n - c)) * 180 / pa) + '"',
                    ca();
                    else {
                        var k = l.r,
                        s = k * 2,
                        ...
                        u = b.radialReference,
                        z, k = function() {
                            u && (z = d.getBBox(), B += (u[0] - z.x) / z.width - 0.5, A += (u[1] - z.y) / z.height - 0.5, s *= u[2] / z.width, v *= u[2] / z.height);
                ...
                } else if (g.test(a) && b.tagName !== "IMG") f = ia(a),
    ...
    Wa.prototype = {
        ...
        render: function(a, b, c) {
            ...
            if (l && y) w === "inside" && (y = -y),
            d.opposite && (y = -y),
            h = this.getMarkPath(u, v, y, l * A, g, f),
            n ? n.animate({
                d: h,
                opacity: c
            ...
            if (i && !isNaN(u)) i.xy = v = this.getLabelPosition(u, v, i, g, j, s, a, q),
            this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? ca = !1 : g && !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && this.handleOverflow(v),
            q && a % q && (ca = !1),
    ...
    ja.prototype = {
        ...
        defaultLabelFormatter: function() {
            ...
            else if (f && a >= 1E3) for (; f--&&g === B;) c = Math.pow(1E3, f + 1),
            a >= c && b * 10 % c === 0 && e[f] !== null && (g = u.numberFormat(b / c, -1) + e[f]);
        ...
        getSeriesExtremes: function() {
            ...
            function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    a.isLog && e <= 0 && (e = null);
                    if (a.isXAxis) {
                        if (d = c.xData, d.length) a.dataMin = E(p(a.dataMin, d[0]), Sa(d)),
                        a.dataMax = s(p(a.dataMax, d[0]), Da(d))
                    } else {
                        c.getExtremes();
                        f = c.dataMax;
                        c = c.dataMin;
                        if (q(c) && q(f)) a.dataMin = E(p(a.dataMin, c), c),
        ...
        adjustForMinRange: function() {
            ...
            f, g, h, i, k, j;
            if (this.isXAxis && this.minRange === B && !this.isLog) q(a.min) || q(a.max) ? this.minRange = null: (o(this.series,
            function(a) {
                i = a.xData;
        ...
        setAxisTranslation: function(a) {
            ...
            function(a) {
                var b = a.closestPointRange; ! a.noSharedTooltip && q(b) && (e = q(e) ? E(e, b) : b)
            }), o(b.series,
            function(a) {
        ...
        setTickInterval: function(a) {
            ...
            n = b.threshold,
            t = b.softThreshold,
            r, X, y, x; ! f && !l && !h && this.getTickAmount();
            y = p(b.userMin, d.min);
            x = p(b.userMax, d.max);
            h ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = p(c.min, c.dataMin), b.max = p(c.max, c.dataMax), d.type !== b.linkedParent.options.type && Y(11, 1)) : (!t && q(n) && (b.dataMin >= n ? (r = n, k = 0) : b.dataMax <= n && (X = n, i = 0)), b.min = p(y, r, b.dataMin), b.max = p(x, X, b.dataMax));
            if (e) ! a && E(b.min, p(b.dataMin, b.min)) <= 0 && Y(10, 1),
            b.min = fa(Ca(b.min), 15),
            b.max = fa(Ca(b.max), 15);
            if (b.range && q(b.max)) b.userMin = b.min = y = s(b.min, b.minFromRange()),
            b.userMax = x = b.max,
            b.range = null;
            b.beforePadding && b.beforePadding();
            b.adjustForMinRange();
            if (!l && !b.axisPointRange && !b.usePercentage && !h && q(b.min) && q(b.max) && (c = b.max - b.min)) ! q(y) && k && (b.min -= c * k),
            !q(x) && i && (b.max += c * i);
            if (ka(d.floor)) b.min = s(b.min, d.floor);
            if (ka(d.ceiling)) b.max = E(b.max, d.ceiling);
            if (t && q(b.dataMin)) if (n = n || 0, !q(y) && b.min < n && b.dataMin >= n) b.min = n;
        ...
        unsquish: function() {
            ...
            function(a) {
                var b;
                if (a === h || a && a >= -90 && a <= 90) k = l(P(i.h / aa(ga * a))),
                b = k + P(a / 360),
                b < j && (j = b, g = a, e = k)
            }) : b.step || (e = l(i.h));
            this.autoRotation = m;
        ...
        renderUnsquish: function() {
            ...
            !j)) {
                m.textOverflow = "clip";
                for (n = c.length; ! f && n--;) if (t = c[n], i = d[t].label) if (i.styles.textOverflow === "ellipsis" && i.css({
                    textOverflow: "clip"
        ...
        getOffset: function() {
            ...
            a.labelGroup = c.g("axis-labels").attr({
                zIndex: r.zIndex || 7
            }).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add(ca);
            if (k || a.isLinked) {
                if (o(e,
                function(b) {
                ...
                }), a.staggerLines) X *= a.staggerLines,
                a.labelOffset = X * (a.opposite ? -1 : 1)
            } else for (v in f) f[v].destroy(),
            delete f[v];
            if (t && t.text && t.enabled !== !1) {
                ...
                }).addClass("highcharts-" + this.coll.toLowerCase() + "-title").css(t.style).add(a.axisGroup),
                a.axisTitle.isNew = !0;
                if (j) m = a.axisTitle.getBBox()[g ? "height": "width"],
                l = t.offset,
                n = q(l) ? 0 : p(t.margin, g ? 5 : 10);
            ...
            x[h] = s(x[h], a.axisTitleMargin + m + w * a.offset, g);
        ...
        render: function() {
            ...
            if (a.hasData() || f) {
                ...
                if (g.length && (o(g,
                function(b, c) {
                    if (!f || b >= a.min && b <= a.max) i[b] || (i[b] = new Wa(a, b)),
                    p && i[b].isNew && i[b].render(c, !0, 0.1),
                    i[b].render(c)
                }), n && (a.min === 0 || a.single))) i[ - 1] || (i[ - 1] = new Wa(a, -1, null, !0)),
                i[ - 1].render( - 1);
                l && o(g,
                function(c, d) {
                    s = g[d + 1] !== B ? g[d + 1] + n: a.max - n;
                    if (d % 2 === 0 && c < a.max && s <= a.max + (b.polar ? -n: n)) j[c] || (j[c] = new u.PlotLineOrBand(a)),
                    w = c + n,
                    j[c].options = {
                        from: e ? la(w) : w,
                        to: e ? la(s) : s,
    ...
    ja.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (q(b)) {
            ...
            if (k === G.week) i[xb](i[$a]() - i[wb]() + p(d, 1));
            b = 1;
            if (rb || ib) i = i.getTime(),
            i = new oa(i + Za(i));
            h = i[bb]();
            for (var d = i.getTime(), m = i[ab](), l = i[$a](), n = (G.day + (g ? Za(i) : i.getTimezoneOffset() * 6E4)) % G.day; d < c;) e.push(d),
            k === G.year ? d = lb(h + b * j, 0) : k === G.month ? d = lb(h, m + b * j) : !g && (k === G.day || k === G.week) ? d = lb(h, m, l + b * j * (k === G.day ? 1 : 7)) : d += k * j,
            b++;
            e.push(d);
            o(Oa(e,
            function(a) {
    ...
    ja.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        else if (a >= 0.08) for (var f = S(b), h, i, k, j, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
            i = e.length;
            for (h = 0; h < i && !m; h++) k = Ca(la(f) * e[h]),
            k > b && (!d || j <= c) && j !== B && g.push(j),
            j > c && (m = !0),
            j = k
        } else if (b = la(b), c = la(c), a = e[d ? "minorTickInterval": "tickInterval"], a = p(a === "auto" ? null: a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length: f) || 1)), a = tb(a, null, sb(a)), g = Ha(this.getLinearTickPositions(a, b, c), Ca), !d) this._minorAutoInterval = a / 5;
    ...
    Pb.prototype = {
        ...
        getAnchor: function(a, b) {
            ...
            k, j, a = ta(a);
            c = a[0].tooltipPos;
            this.followPointer && b && (b.chartX === B && (b = d.pointer.normalize(b)), c = [b.chartX - d.plotLeft, b.chartY - f]);
            c || (o(a,
            function(a) {
                k = a.series.yAxis;
                j = a.series.xAxis;
        ...
        refresh: function(a, b) {
            ...
            f = h[0];
            g = h[1];
            l && (!a.series || !a.series.noSharedTooltip) ? (c.hoverPoints = a, i && o(i,
            function(a) {
                a.setState()
            }), o(a,
            function(a) {
        ...
        getXDateFormat: function(a, b, c) {
            ...
            if (e) {
                ...
                for (f in G) {
                    if (e === G.week && +Ra("%w", a.x) === c.options.startOfWeek && h.substr(6) === "00:00:00.000") {
                        f = "week";
                        break
                    }
                    if (G[f] > e) {
    ...
    Ya.prototype = {
        init: function(a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (u.Tooltip && b.tooltip.enabled) a.tooltip = new Pb(a, b.tooltip),
        ...
        normalize: function(a, b) {
            ...
            d.pageX === B ? (c = s(a.x, a.clientX - b.left), d = a.y) : (c = d.pageX - b.left, d = d.pageY - b.top);
            return v(a, {
                chartX: A(c),
                chartY: A(d)
            })
        ...
        reset: function(a, b) {
            ...
            f = c.hoverPoints,
            g = c.tooltip,
            h = g && g.shared ? f: e; (a = a && g && h) && o(ta(h),
            function(b) {
                b.plotX === void 0 && (a = !1)
            });
            if (a) g.refresh(h),
            ...
            function(a) {
                ...
                if (d) d.onMouseOut();
                g && g.hide(b);
                if (this._onDocumentMouseMove) U(z, "mousemove", this._onDocumentMouseMove),
    ...
    v(u.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
            ...
            u = !w && c[1][m],
            A,
            c = function() { ! w && P(q - v) > 20 && (p = h || P(s - u) / P(q - v));
                r = (n - s) / p + q;
    ...
    if (C.PointerEvent || C.MSPointerEvent) {
        ...
        Eb = function(a, b, c, d) {
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && W[ra]) d(a),
            d = W[ra].pointer,
            d[b]({
                type: c,
        ...
        v(Ya.prototype, {
            onContainerPointerDown: function(a) {
                Eb(a, "onContainerTouchStart", "touchstart",
                function(a) {
                    wa[a.pointerId] = {
                        pageX: a.pageX,
                        pageY: a.pageY,
            ...
            onContainerPointerMove: function(a) {
                Eb(a, "onContainerTouchMove", "touchmove",
                function(a) {
                    wa[a.pointerId] = {
                        pageX: a.pageX,
                        pageY: a.pageY
            ...
            onDocumentPointerUp: function(a) {
                Eb(a, "onDocumentTouchEnd", "touchend",
                function(a) {
    ...
    pb.prototype = {
        ...
        renderItem: function(a) {
            ...
            if (!o) {
                ...
                this.baseline = this.fontMetrics.f + 3 + t,
            ...
            if (e && this.itemX - r + f > (l || b.chartWidth - 2 * k - r - d.x)) this.itemX = r,
            this.itemY += t + this.lastLineHeight + n,
        ...
        handleOverflow: function(a) {
            ...
            if (a > f) {
                ...
                function(a, b) {
                    ...
                    e = n.length;
                    if (!e || c - n[e - 1] > h && (r || c) !== n[e - 1]) n.push(r || c),
                    e++;
                    b === q.length - 1 && c + d - n[e - 1] > h && n.push(c);
                    c !== r && (r = c)
                });
                if (!i) i = b.clipRect = d.clipRect(0, t, 9999, 0),
                ...
                this.pager = d.text("", 15, 10).css(k.style).add(l),
    ...
    hb.prototype = {
        ...
        initSeries: function(a) {
            var b = this.options.chart; (b = I[a.type || b.type || b.defaultSeriesType]) || Y(17, !0);
            b = new b;
            b.init(this, a);
            return b
        },
        ...
        getChartSize: function() {
            ...
            if (!q(b)) this.containerWidth = Ga(c, "width");
        ...
        getContainer: function() {
            ...
            a || Y(13, !0);
            d = F(L(a, "data-highcharts-chart")); ! isNaN(d) && W[d] && W[d].hasRendered && W[d].destroy();
        ...
        setSize: function(a, b, c) {
            ...
            if (q(a)) d.chartWidth = e = s(0, A(a)),
            d.hasUserSize = !!e;
            if (q(b)) d.chartHeight = f = s(0, A(b));
            a = g.globalAnimation; (a ? Xa: M)(d.container, {
                width: e + "px",
                height: f + "px"
            },
            a);
        ...
        setChartSize: function(a) {
            ...
            this.plotHeight = m = s(0, A(e - k - this.marginBottom));
        ...
        linkSeries: function() {
            ...
            function(b) {
                ...
                if (ya(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d))) d.linkedSeries.push(b),
                b.linkedParent = d,
    ...
    R.prototype = {
        ...
        bindAxes: function() {
            ...
            function(e) {
                ...
                function(c) {
                    d = c.options;
                    if (b[e] === d.index || b[e] !== B && b[e] === d.id || b[e] === B && d.index === 0) c.series.push(a),
                    a[e] = c,
                    c.isDirty = !0
        ...
        autoIncrement: function() {
            ...
            if (d === "month" || d === "year") a = new oa(b),
            a = d === "month" ? +a[yb](a[ab]() + c) : +a[zb](a[bb]() + c),
            c = a - b;
            this.xIncrement = b + c;
            return b
        },
            ...
            function(a, b) {
                ...
                if (n && h > n) {
                    ...
                    if (ka(j)) {
                        ...
                        l += j;
                        e.xIncrement = l
                    } else if (Ja(j)) if (s) for (c = 0; c < h; c++) j = a[c],
                    t[c] = j[0],
                    r[c] = j.slice(1, s + 1);
        ...
        processData: function(a) {
            ...
            m = a.min,
            l = a.max;
            if (j && this.sorted && !k && (!i || d > i || this.forceCrop)) if (b[d - 1] < m || b[0] > l) b = [],
            c = [];
            ...
            d > 0 && (g === B || d < g) ? g = d: d < 0 && this.requireSorting && Y(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        generatePoints: function() {
            ...
            b = this.data = b;
            for (l = 0; l < g; l++) i = h + l,
            k ? m[l] = (new f).init(this, [d[l]].concat(ta(e[l]))) : (b[i] ? j = b[i] : a[i] !== B && (b[i] = j = (new f).init(this, a[i], d[l])), m[l] = j),
            m[l].index = i;
        ...
        getExtremes: function(a) {
            ...
            d = a.length;
            for (m = 0; m < d; m++) if (k = c[m], j = a[m], i = j !== null && j !== B && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[m + 1] || k) >= g && (c[m - 1] || k) <= h, i && k) if (i = j.length) for (; i--;) j[i] !== null && (e[f++] = j[i]);
            else e[f++] = j;
            this.dataMin = Sa(e);
            this.dataMax = Da(e)
        },
        translate: function() {
            ...
            h = !!this.modifyValue,
            i = a.pointPlacement,
            k = i === "between" || ka(i), j = a.threshold, m = a.startFromThreshold ? j: 0, l, n, t, o, v = Number.MAX_VALUE, a = 0; a < g; a++) {
                var y = f[a],
                x = y.x,
                w = y.y;
                n = y.low;
                var u = b && e.stacks[(this.negStacks && w < (m ? 0 : j) ? "-": "") + this.stackKey];
                if (e.isLog && w !== null && w <= 0) y.y = w = null,
                Y(10);
                y.plotX = l = E(s( - 1E5, c.translate(x, 0, 0, 0, 1, i, this.type === "flags")), 1E5);
                if (b && this.visible && u && u[x]) o = this.getStackIndicator(o, x, this.index),
                u = u[x],
                w = u.points[o.key],
                n = w[0],
                w = w[1],
                n === m && (n = p(j, e.min)),
                e.isLog && n <= 0 && (n = null),
                y.total = y.stackTotal = u.total,
                y.percentage = u.total && y.y / u.total * 100,
                y.stackY = w,
        ...
        drawPoints: function() {
            ...
            if (m.enabled !== !1 || this._hasPointMarkers) for (f = b.length; f--;) if (g = b[f], d = S(g.plotX), e = g.plotY, j = g.graphic, n = g.marker || {},
            o = !!g.marker, a = s && n.enabled === B || n.enabled, r = g.isInside, a && e !== B && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select": ""] || l, h = a.r, i = p(n.symbol, this.symbol), k = i.indexOf("url") === 0, j) j[r ? "show": "hide"](!0).animate(v({
                x: d - h,
                y: e - h
            },
            j.symbolName ? {
        ...
        applyZones: function() {
            ...
            x,
            v = !1;
            if (d.length && (i || k) && m.min !== B) i && i.hide(),
            k && k.hide(),
            l = m.getExtremes(),
            o(d,
            function(d, o) {
    ...
    xa = na(R, {
        ...
        getColumnMetrics: function() {
            ...
            function(b) {
                ...
                e = b.yAxis,
                i;
                if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos) c.stacking ? (f = b.stackKey, g[f] === B && (g[f] = h++), i = g[f]) : c.grouping !== !1 && (i = h++),
                b.columnIndex = i
            });
        ...
        translate: function() {
            ...
            function(c) {
                ...
                c.shapeType = "rect";
                c.shapeArgs = a.crispCol(o, v, q, u)
            })
        },
        getSymbol: va,
        drawLegendSymbol: K.drawRectangle,
        ...
        drawPoints: function() {
            ...
            function(h) {
                var i = h.plotY,
                k = h.graphic;
                if (i !== B && !isNaN(i) && h.y !== null) f = h.shapeArgs,
                i = q(a.borderWidth) ? {
                    "stroke-width": a.borderWidth
                }: {},
                g = h.pointAttr[h.selected ? "select": ""] || a.pointAttr[""],
                k ? (Pa(k), k.attr(i).attr(g)[b.pointCount < e ? "animate": "attr"](D(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(h.group || a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
                ...
                if (L) {
                    ...
                    if (l > 0) {
                        ...
                        for (J = 0; J < L; J++) {
                            ...
                            c = 9999;
                            var Q, O;
                            for (O = 0; O < x; O++) Q = P(H[O] - w[1]),
                            Q < c && (c = Q, K = O);
                            if (K < J && H[J] !== null) K = J;
                            else for (x < L - J + K && H[J] !== null && (K = x - L + J); H[K] === null;) K++;
                            N.push({
                                i: K,
                                y: H[K]
                            });
                    ...
                    for (J = 0; J < L; J++) {
                        ...
                        c = w[1];
                        if (l > 0) {
                            if (x = N.pop(), K = x.i, C = x.y, c > C && H[K + 1] !== null || c < C && H[K - 1] !== null) C = E(s(0, c), d.plotHeight)
                        } else C = c;
                        ...
                        u.connX = z;
                        u.connY = C;
                        if (this.options.size === null) x = u.width,
                        z - x < f ? G[3] = s(A(x - z + f), G[3]) : z + x > h - f && (G[1] = s(A(z + x - h + f), G[1])),
                        C - b / 2 < 0 ? G[0] = s(A( - C + b / 2), G[0]) : C + b / 2 > i && (G[2] = s(A(C + b / 2 - i), G[2]))
                    }
                }
            }
            if (Da(G) === 0 || this.verifyDataLabelOverflow(G)) this.placeDataLabels(),
            v && g && o(this.points,
            function(b) {
                k = b.connector;
                w = b.labelPos;
                ...
                z = u.connX,
                C = u.connY,
                j = m ? ["M", z + (w[6] === "left" ? 5 : -5), C, "C", z, C, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", z + (w[6] === "left" ? 5 : -5), C, "L", w[2], w[3], "L", w[4], w[5]],
                k ? (k.animate({
                    d: j
    ...
    ea = u.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
            ...
            if (e && !c) for (l = e + 1; l--;) d[l] === "M" && d.splice(l + 1, 0, d[l + 1] - i, d[l + 2], "L"),
            (l && d[l] === "M" || l === e) && d.splice(l, 0, "L", d[l - 2] + i, d[l - 1]);
            for (l = 0; l < j.length; l++) e = j[l],
    ...
    v(hb.prototype, {
        ...
        pan: function(a, b) {
            ...
            function(b) {
                ...
                i = i > d;
                if (h.series.length && (i || m > E(j.dataMin, j.min)) && (!i || k < s(j.dataMax, j.max))) h.setExtremes(m, k, !1, !1, {
                    trigger: "pan"
                }),
                e = !0;
    ...
    v(Ia.prototype, {
        ...
        onMouseOut: function() {
            ...
            if (!b || qa(this, b) === -1) this.setState(),
            a.hoverPoint = null
        },
        ...
        setState: function(a, b) {
            ...
            if (! (a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && i.enabled === !1) || a && m.states && m.states[a] && m.states[a].enabled === !1)) {
                ...
                j && j.hide();
                    ...
                    j.currentSymbol = m;
                    if (j) j[a && l.isInsidePlot(c, d, l.inverted) ? "show": "hide"](),
